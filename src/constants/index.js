        ...
        roles: [
            ...
            },
            {
                ...
                points: [
                    ...
                    "Monitoring reservations, making sure they were correctly inputted into the system",
            ...
            },
            {
                ...
                points: [
                    ...
                    "Dealing with general phone and e-mail queries in a professional and timely manner",
                    "Registering check-ins and check-outs and updating relevant data on the system",
        ...
        roles: [
            {
                ...
                points: [
                    ...
                    "Working collaboratively with other departments to improve the service",
                    "Giving periodic reports to demonstrate the team progress",
                    "Performing quality evaluations of recorded calls to detect improvements",
                    "Overseeing daily operations",
                    "Elaborating action plans to overcome team weaknesses",
                ],          
            },
            {
                ...
                points: [
                    ...
                    "Data analysis and presentations of the agent’s performance",
                    "Giving personalized feedback face to face of the calls evaluated",
            ...
            },
            {
                ...
                points: [
                    "Welcoming and greeting guests in a warm and friendly wayAnswering calls, chats, and emails from the bank’s users providing a quality and efficient service, focused on customer satisfaction",
                    "Escalating punctual cases to another departments or supervisors",
...
export const projects = [
    ...
    },
    {
        ...
        description: 'This is an application created with python that allows the user to manage an inventory by adding orders, updating the quantity by selling them and generates graphs to represent the demand through the time. It has a login system and allows them to create/modidy/delete users ',
    ...
    },
    {
        ...
        description: 'This model written in Python takes a large amount of animal pictures clasified by type, after being trained it is able to clasify correctly around 20% of the test pictures',
    ...
    },
    {
        ...
        description: 'A Java project to manage college procedures such as register students and enroll them into Branches/Degrees/Courses as well as manage their attendance and grades. It has a log in system with 3 different privileges: Admin, Academic and Student. All the information is stores in MySQL',
    ...
    },
    {
        ...
        theme: 'btn-back-black',
        name: '3D website',
        description: 'You can fin the code of this very webpage here, it was coded using react,  three.js and tailwindCSS',
        images: [web1, web2],
    ...
    },
    {
        ...
        description: 'All the 3D models used on this website were designed by myslef using blender, the most representative is the quetzalcoatl but you can find more in my repositories',
    ...
    },
    {
        ...
        description: 'This interface allows the user to perform CRUD operations (Create, Read, Update and Delete) for college operations like enrolling students and modules. This is coded in PHP and uses SQL as data managment',
